...
// 		m_root->set_pattern("[%Y-%m-%d %H:%M:%S.%e] [%n] [%^%l%$] [thread %t] :
// %v"); 		m_loggers["root"] = m_root;
//
// 		Init();
// 	}
//
...
// 		logger->set_pattern("[%Y-%m-%d %H:%M:%S.%e] [%n] [%^%l%$] [thread %t] :
// %v"); 		m_loggers[name] = logger; 		return logger;
// 	}
//
// 	void Init() {  }
//
